...
struct libavl_allocator {
    void *(*libavl_malloc)(struct libavl_allocator* allocator,
        size_t libavl_size);
    void (*libavl_free)(struct libavl_allocator* allocator,
        void* libavl_block);
};
#endif
...
void rb_free(struct libavl_allocator* allocator, void* ptr);
...
void* rb_insert(struct rb_table* tree, void* item);
void* rb_replace(struct rb_table* tree, void* item);
void* rb_delete(struct rb_table* tree, const void* item);
void* rb_find(const struct rb_table* tree, const void* item);
void rb_assert_insert(struct rb_table* tree, void* item);
void* rb_assert_delete(struct rb_table* tree, void* item);
...
void* rb_t_replace(struct rb_traverser* trav, void* item);
